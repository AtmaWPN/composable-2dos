...
interface Api {
	...
	val appRelease: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.atmaweapon.composable2dos.AppRelease, kotlin.uuid.Uuid>

	val user: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.atmaweapon.composable2dos.User, kotlin.uuid.Uuid>

	val taskSet: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.atmaweapon.composable2dos.TaskSet, kotlin.uuid.Uuid>

	val task: com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.atmaweapon.composable2dos.Task, kotlin.uuid.Uuid>

	interface UserAuthApi : com.lightningkite.lightningserver.sessions.proofs.AuthClientEndpoints<com.atmaweapon.composable2dos.User, kotlin.uuid.Uuid>, com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.lightningkite.lightningserver.sessions.Session<com.atmaweapon.composable2dos.User, kotlin.uuid.Uuid>, kotlin.uuid.Uuid> {
	...
	interface FcmTokenApi : com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.atmaweapon.composable2dos.FcmToken, kotlin.String> {
		/**
		 * Register Token
		 * 
		 * **Auth Requirements:** User with root access
		 * */
		suspend fun registerToken(input: kotlin.String): com.lightningkite.services.database.EntryChange<com.atmaweapon.composable2dos.FcmToken>
		/**
