...
class LiveApi(val fetcher: Fetcher) : Api {
	...
	override val appRelease = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "app-releases", com.atmaweapon.composable2dos.AppRelease.serializer(), kotlin.uuid.Uuid.serializer())

	override val user = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "users", com.atmaweapon.composable2dos.User.serializer(), kotlin.uuid.Uuid.serializer())

	override val taskSet = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "task-sets", com.atmaweapon.composable2dos.TaskSet.serializer(), kotlin.uuid.Uuid.serializer())

	override val task = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "tasks", com.atmaweapon.composable2dos.Task.serializer(), kotlin.uuid.Uuid.serializer())

	inner class LiveUserAuthApi : Api.UserAuthApi, com.lightningkite.lightningserver.sessions.proofs.AuthClientEndpoints<com.atmaweapon.composable2dos.User, kotlin.uuid.Uuid> by com.lightningkite.lightningserver.sessions.proofs.LiveAuthClientEndpoints(fetcher, "auth/session", com.atmaweapon.composable2dos.User.serializer(), kotlin.uuid.Uuid.serializer()), com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.lightningkite.lightningserver.sessions.Session<com.atmaweapon.composable2dos.User, kotlin.uuid.Uuid>, kotlin.uuid.Uuid> by com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "auth/session/sessions", com.lightningkite.lightningserver.sessions.Session.serializer(com.atmaweapon.composable2dos.User.serializer(), kotlin.uuid.Uuid.serializer()), kotlin.uuid.Uuid.serializer()) {
	...
	inner class LiveFcmTokenApi : Api.FcmTokenApi, com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.atmaweapon.composable2dos.FcmToken, kotlin.String> by com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "fcmTokens", com.atmaweapon.composable2dos.FcmToken.serializer(), kotlin.String.serializer()) {
		override suspend fun registerToken(input: kotlin.String): com.lightningkite.services.database.EntryChange<com.atmaweapon.composable2dos.FcmToken> =
			fetcher("fcmTokens/register", HttpMethod.POST, kotlin.String.serializer(), input, com.lightningkite.services.database.EntryChange.serializer(com.atmaweapon.composable2dos.FcmToken.serializer()))
