...
import com.atmaweapon.composable2dos.data.*
...
object Server : ServerBuilder() {
    ...
    val taskSets = path.path("task-sets") module TaskSetEndpoints
    val tasks = path.path("tasks") module TaskEndpoints
