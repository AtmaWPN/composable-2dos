...
fun sdk() = engine {
    ...
    FetcherSdk("com.atmaweapon.composable2dos.sdk").writeUsingDefaultSettings(
        Server,
        KFile("apps/src/commonMain/kotlin/com/atmaweapon/composable2dos/sdk")
    )
    Utils.logger.info { "Generating CachingSdk" }
    CachingSdk("com.atmaweapon.composable2dos.sdk").writeUsingDefaultSettings(
        Server,
        KFile("apps/src/commonMain/kotlin/com/atmaweapon/composable2dos/sdk")
    )
