...
class LiveApi(val fetcher: Fetcher) : Api {
	...
	override val taskSet = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "task-sets", com.lightningkite.lskiteuistarter.TaskSet.serializer(), kotlin.uuid.Uuid.serializer())

	override val task = com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "tasks", com.lightningkite.lskiteuistarter.Task.serializer(), kotlin.uuid.Uuid.serializer())
