...
open class CachedApi(val uncached: Api) {
	...
	open val taskSets = ModelCache(uncached.taskSet, com.lightningkite.lskiteuistarter.TaskSet.serializer())
	open val tasks = ModelCache(uncached.task, com.lightningkite.lskiteuistarter.Task.serializer())
